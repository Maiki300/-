...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? '𝘾𝞗𝞛𝞛𝞓𝞜𝘿𝞢𝞒' : process.env.ALL_CAPTION,
    ...
    ALIVEMSG: process.env.ALIVE_MESSAGE === undefined ? 'alive to serve 𝘾𝞗𝞛𝞛𝞓𝞜𝘿𝞢𝞒' : process.env.ALIVE_MESSAGE,
    KICKMEMSG: process.env.KICKME_MESSAGE === undefined ? 'die you weakling' : process.env.KICKME_MESSAGE,
    M_REPLY: process.env.M_REPLY === undefined ? 'Tatakai' : process.env.M_REPLY,
    M_REPLY_VAR: process.env.M_REPLY_VAR === undefined ? 'true' : process.env.M_REPLY_VAR,
    AFNN: process.env.TAG_REPLY === undefined ? '14157614157@s.whatsapp.net' : process.env.TAG_REPLY,
    NBSK: process.env.ALL_NUMBER === undefined ? '14157614157' : process.env.ALL_NUMBER,
    ...
    ADDMSG: process.env.ADD_MESSAGE === undefined ? 'do not make yourself at home, Tatakai till the end' : process.env.ADD_MESSAGE,
    MUTEMSG: process.env.MUTE_MESSAGE === undefined ? 'default' : process.env.MUTE_MESSAGE,
    PLK: process.env.OWNER_NAME === undefined ? '𝘾𝞗𝞛𝞛𝞓𝞜𝘿𝞢𝞒¹¹' : process.env.OWNER_NAME,
    SONGD: process.env.SONGD === undefined ? ' 𝘾𝞗𝞛𝞛𝞓𝞜𝘿𝞢𝞒 is looking.. 🔍' : process.env.SONGD,
    ...
    SKV: process.env.V_HEADER === undefined ? 'TATAKAI' : process.env.V_HEADER,
    SKDR: process.env.DURATION === undefined ? '99978509' : process.env.DURATION,
    HANDLERS: process.env.HANDLERS === undefined ? '^[.!;]' : process.env.HANDLERS,
    SEND_READ: process.env.SEND_READ === undefined ? false : convertToBool(process.env.SEND_READ),
    YAK: process.env.YAK === undefined ? '447418329446' : process.env.YAK,
